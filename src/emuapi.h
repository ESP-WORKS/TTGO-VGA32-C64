...
// DAT do PS/2. O direcional vem pela ponte T-Display.
#define NO_ANALOG_JOYSTICK 1
// USE_WIRE dependia de components/Wire, que e' um recorte do core Arduino
// 1.0.x (rom/ets_sys.h, timer_group_struct.h) e nao compila na IDF 5.
// Desligado: cai no caminho driver/i2c.h nativo, ja escrito em emuapi.cpp.
//#define USE_WIRE    1
...
// Frequencia do SPI do cartao SD. 10000 era o original do MCUME e e' agressivo
// para cartao em soquete de placa de dev; 4000 costuma estabilizar.
