...
#if defined(HAS_TDISPLAY_LINK) || defined(HAS_PS2KBD)
#define HAS_HELD_KEYS 1
/* Tecla SEGURADA injetada direto na matriz do teclado.

   setKey() e' um pulso de 20 ms e nao consegue representar uma tecla mantida
   pressionada -- serve para digitar no BASIC, mas em jogo a tecla precisa
